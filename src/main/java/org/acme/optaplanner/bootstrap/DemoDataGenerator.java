...
public class DemoDataGenerator {
    ...
    public void generateDemoData(@Observes StartupEvent startupEvent) {
        ...
        timeslotList.add(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(8, 00), LocalTime.of(9, 35)));
        timeslotList.add(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 50), LocalTime.of(11, 25)));
        timeslotList.add(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(11, 55), LocalTime.of(13, 30)));
        timeslotList.add(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(13, 45), LocalTime.of(15, 20)));

        timeslotList.add(new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(8, 00), LocalTime.of(9, 35)));
        timeslotList.add(new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(9, 50), LocalTime.of(11, 25)));
        timeslotList.add(new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(11, 55), LocalTime.of(13, 30)));
        timeslotList.add(new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(13, 45), LocalTime.of(15, 20)));


        timeslotList.add(new Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(8, 00), LocalTime.of(9, 35)));
        timeslotList.add(new Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(9, 50), LocalTime.of(11, 25)));
        timeslotList.add(new Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(11, 55), LocalTime.of(13, 30)));
        timeslotList.add(new Timeslot(DayOfWeek.WEDNESDAY, LocalTime.of(13, 45), LocalTime.of(15, 20)));


        timeslotList.add(new Timeslot(DayOfWeek.THURSDAY, LocalTime.of(8, 00), LocalTime.of(9, 35)));
        timeslotList.add(new Timeslot(DayOfWeek.THURSDAY, LocalTime.of(9, 50), LocalTime.of(11, 25)));
        timeslotList.add(new Timeslot(DayOfWeek.THURSDAY, LocalTime.of(11, 55), LocalTime.of(13, 30)));
        timeslotList.add(new Timeslot(DayOfWeek.THURSDAY, LocalTime.of(13, 45), LocalTime.of(15, 20)));

        timeslotList.add(new Timeslot(DayOfWeek.FRIDAY, LocalTime.of(8, 00), LocalTime.of(9, 35)));
        timeslotList.add(new Timeslot(DayOfWeek.FRIDAY, LocalTime.of(9, 50), LocalTime.of(11, 25)));
        timeslotList.add(new Timeslot(DayOfWeek.FRIDAY, LocalTime.of(11, 55), LocalTime.of(13, 30)));
        timeslotList.add(new Timeslot(DayOfWeek.FRIDAY, LocalTime.of(13, 45), LocalTime.of(15, 20)));

        timeslotRepository.persist(timeslotList);

        List<Room> roomList = new ArrayList<>(3);
        roomList.add(new Room("221"));
        roomList.add(new Room("228"));
        roomList.add(new Room("341"));
        ...
        lessonList.add(new Lesson("Math", "A. Turing", "117"));
        lessonList.add(new Lesson("Math", "A. Turing", "127"));
        lessonList.add(new Lesson("Physics", "M. Curie", "117"));
        lessonList.add(new Lesson("History", "I. Jones", "117"));
        lessonList.add(new Lesson("English", "I. Jones", "117"));
        lessonList.add(new Lesson("English", "I. Jones", "127"));
        lessonList.add(new Lesson("Spanish", "P. Cruz", "127"));
        lessonList.add(new Lesson("Spanish", "P. Cruz", "147"));
        /*if (demoData == DemoData.LARGE) {
        ...
        lessonList.add(new Lesson("Technologies of computer design", "A. Lovelace", "137"));
        lessonList.add(new Lesson("Technologies of computer design", "A. Lovelace", "147"));
        lessonList.add(new Lesson("Computer Engineering", "Charles Babbage", "127"));
        lessonList.add(new Lesson("Computer Engineering", "Charles Babbage", "147"));
        lessonList.add(new Lesson("Computer Science", "Charles Babbage", "117"));
